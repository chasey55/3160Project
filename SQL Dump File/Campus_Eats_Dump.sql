...
--
-- Temporary view structure for view `driver_description`
--

DROP TABLE IF EXISTS `driver_description`;
/*!50001 DROP VIEW IF EXISTS `driver_description`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `driver_description` AS SELECT 
 1 AS `driver_id`,
 1 AS `avg_score`,
 1 AS `Driver Quality Description`*/;
...
--
-- Temporary view structure for view `rating_over_4`
--

DROP TABLE IF EXISTS `rating_over_4`;
/*!50001 DROP VIEW IF EXISTS `rating_over_4`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rating_over_4` AS SELECT 
 1 AS `Restaurant`,
 1 AS `avg_rating`*/;
SET character_set_client = @saved_cs_client;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `calculate_avg_rating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
--
-- Final view structure for view `driver_description`
--
...
/*!50001 VIEW `driver_description` AS select `rating`.`driver_id` AS `driver_id`,avg(`rating`.`score`) AS `avg_score`,(case when (avg(`rating`.`score`) >= 5) then 'This is a good driver.' when ((avg(`rating`.`score`) >= 4) and (avg(`rating`.`score`) < 5)) then 'This is an average driver.' else 'This is a bad driver.' end) AS `Driver Quality Description` from `rating` group by `rating`.`driver_id` */;
...
--
-- Final view structure for view `rating_over_4`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rating_over_4` AS select `restaurant`.`restaurant_name` AS `Restaurant`,`sub`.`avg_rating` AS `avg_rating` from (`restaurant` join (select `rating`.`restaurant_id` AS `restaurant_id`,avg(`rating`.`score`) AS `avg_rating` from `rating` group by `rating`.`restaurant_id`) `sub`) where (`restaurant`.`restaurant_id` = `sub`.`restaurant_id`) group by `restaurant`.`restaurant_name` having (`sub`.`avg_rating` > 4) order by `sub`.`avg_rating` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-12-13 20:10:58
